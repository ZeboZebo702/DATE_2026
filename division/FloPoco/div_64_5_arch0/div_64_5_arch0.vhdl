...
--------------------------------------------------------------------------------
--                     IntConstDiv_QR_5_64_0_6_comb_uid2
-- VHDL generated for Kintex7 @ 0MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: Q R
--  approx. input signal timings: X: 0.000000ns
--  approx. output signal timings: Q: 5.973000nsR: 5.973000ns
...
entity IntConstDiv_QR_5_64_0_6_comb_uid2 is
    port (X : in  std_logic_vector(63 downto 0);
          Q : out  std_logic_vector(61 downto 0);
          R : out  std_logic_vector(2 downto 0)   );
end entity;

architecture arch of IntConstDiv_QR_5_64_0_6_comb_uid2 is
...
begin
   ...
   x8 <= X(53 downto 48);
   in8 <= r9 & x8;
   table8: EuclideanDivTable_d5_alpha6_comb_uid6
      port map ( X => in8,
                 Y => out8);
   q8 <= out8(8 downto 3);
   r8 <= out8(2 downto 0);
   x7 <= X(47 downto 42);
   in7 <= r8 & x7;
   table7: EuclideanDivTable_d5_alpha6_comb_uid6
      port map ( X => in7,
                 Y => out7);
   q7 <= out7(8 downto 3);
   r7 <= out7(2 downto 0);
   x6 <= X(41 downto 36);
   in6 <= r7 & x6;
   table6: EuclideanDivTable_d5_alpha6_comb_uid6
      port map ( X => in6,
                 Y => out6);
   q6 <= out6(8 downto 3);
   r6 <= out6(2 downto 0);
   ...
   q0 <= out0(8 downto 3);
   r0 <= out0(2 downto 0);
   tempQ <= q10 & q9 & q8 & q7 & q6 & q5 & q4 & q3 & q2 & q1 & q0 ;
   Q <= tempQ(61 downto 0);
   R <= r0;
end architecture;
