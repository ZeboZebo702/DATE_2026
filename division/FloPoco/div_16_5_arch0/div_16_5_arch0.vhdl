...
--------------------------------------------------------------------------------
--                     IntConstDiv_QR_5_16_0_6_comb_uid2
-- VHDL generated for Kintex7 @ 0MHz
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
-- Output signals: Q R
--  approx. input signal timings: X: 0.000000ns
--  approx. output signal timings: Q: 1.629000nsR: 1.629000ns
...
entity IntConstDiv_QR_5_16_0_6_comb_uid2 is
    port (X : in  std_logic_vector(15 downto 0);
          Q : out  std_logic_vector(13 downto 0);
          R : out  std_logic_vector(2 downto 0)   );
end entity;

architecture arch of IntConstDiv_QR_5_16_0_6_comb_uid2 is
