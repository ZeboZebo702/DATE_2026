...
assign r_1 =  q_2[9:4] + q_3[9:4]+ q_4[9:4] + q_5[9:4];

assign r_2 = q_1[10] + q_2[15:10] + q_3[15:10] + q_4[15:10] + q_5[15:10];

assign r_3 =  q_2[16] + q_3[21:16] + q_4[21:16] + q_5[21:16];

assign r_4 =  q_3[22] + q_4[27:22] + q_5[27:22];

assign r_5 = q_4[28] + q_5[33:28];



wire [6:1] r_1_1,r_1_2,r_2_3,r_3_4, r_4_5;

assign r_1_1 = r_1[6:1] + sum[6:4];

assign r_1_2 = r_2[6:1] + r_1[8:7];

assign r_2_3 = r_3[6:1] + r_2[8:7];

assign r_3_4 = r_4[6:1] + r_3[8:7];

assign r_4_5 = r_5 + r_4[7];



assign Q = {r_4_5, r_3_4, r_2_3, r_1_2, r_1_1};
