...
assign r_2 = q_1[15] + q_2[21:15] + q_3[21:15] + q_4[21:15] + q_5[21:15] + q_6[21:15];

assign r_3 = q_2[22] + q_3[28:22] + q_4[28:22] + q_5[28:22] + q_6[28:22];

assign r_4 = q_3[29] + q_4[35:29] + q_5[35:29] + q_6[35:29];

assign r_5 = q_4[36] + q_5[42:36] + q_6[42:36];

assign r_6 = q_5[43] + q_6[49:43];



wire [7:1] r_1_1,r_1_2,r_2_3,r_3_4,r_4_5, r_5_6;

assign r_1_1 = r_1[7:1] + sum[10:8];

assign r_1_2 = r_2[7:1] + r_1[10:8];

assign r_2_3 = r_3[7:1] + r_2[10:8];

assign r_3_4 = r_4[7:1] + r_3[9:8];

assign r_4_5 = r_5[7:1] + r_4[9:8];

assign r_5_6 = r_6 + r_5[8];



assign Q = {r_5_6, r_4_5, r_3_4, r_2_3, r_1_2, r_1_1};
