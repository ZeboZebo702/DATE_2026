...
assign r_2 = q_1[17] + q_2[24:17] + q_3[24:17] + q_4[24:17] + q_5[24:17];

assign r_3 = q_2[25] + q_3[32:25] + q_4[32:25] + q_5[32:25];

assign r_4 = q_3[33] + q_4[40:33] + q_5[40:33];

assign r_5 = q_4[41] + q_5[48:41];

assign r_6 = q_5[49];


wire [8:1] r_1_1,r_1_2,r_2_3,r_3_4,r_4_5;

assign r_1_1 = r_1[8:1] + sum[11:9];

assign r_1_2 = r_2[8:1] + r_1[11:9];

assign r_2_3 = r_3[8:1] + r_2[10:9];

assign r_3_4 = r_4[8:1] + r_3[10:9];

assign r_4_5 = r_5[8:1] + r_4[9];

//assign r_5_6 = r_6 + r_5[8];



assign Q = {r_6, r_4_5, r_3_4, r_2_3, r_1_2, r_1_1 };
