...
assign r_2 =  q_1[13] + q_2[18:13] + q_3[18:13] + q_4[18:13] + q_5[18:13] + q_6[18:13] + q_7[18:13];

assign r_3 =  q_2[19] + q_3[24:19] + q_4[24:19] + q_5[24:19] + q_6[24:19] + q_7[24:19];

assign r_4 =  q_3[25] + q_4[30:25] + q_5[30:25] + q_6[30:25] + q_7[30:25];

assign r_5 =  q_4[31] + q_5[36:31] + q_6[36:31] + q_7[36:31];

assign r_6 = q_5[37] + q_6[42:37] + q_7[42:37];

assign r_7 = q_6[43] + q_7[48:43];

assign r_8 = q_7[49];



wire [6:1] r_1_1,r_1_2,r_2_3,r_3_4,r_4_5, r_5_6, r_6_7;


assign r_1_1 = r_1[6:1] + sum[9:7];

assign r_1_2 = r_2[6:1] + r_1[9:7];

assign r_2_3 = r_3[6:1] + r_2[9:7];

assign r_3_4 = r_4[6:1] + r_3[8:7];

assign r_4_5 = r_5[6:1] + r_4[8:7];

assign r_5_6 = r_6[6:1] + r_5[7];

assign r_6_7 = r_7[6:1] + r_6[7];


assign Q = {r_8, r_6_7, r_5_6, r_4_5, r_3_4  ,r_2_3, r_1_2, r_1_1};
